...
**enableParallelism** | **Boolean** | EnableParallelism enables parallel artifact operations (uploads/downloads). Defaults to false. |  [optional]
...
**parallelism** | **Integer** | Parallelism limits the maximum number of parallel artifact operations (uploads/downloads) when EnableParallelism is true. Defaults to 0 (no limit). |  [optional]
