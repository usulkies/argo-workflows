...
class IoArgoprojWorkflowV1alpha1S3ArtifactRepository(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            enable_parallelism (bool): EnableParallelism enables parallel artifact operations (uploads/downloads). Defaults to false.. [optional]  # noqa: E501
            ...
            file_count_threshold (int): FileCountThreshold enables parallel operations when the number of files exceeds this threshold and EnableParallelism is true. Defaults to 0 (always use parallelism if > 1 file).. [optional]  # noqa: E501
            ...
            parallelism (int): Parallelism limits the maximum number of parallel artifact operations (uploads/downloads) when EnableParallelism is true. Defaults to 0 (no limit).. [optional]  # noqa: E501
